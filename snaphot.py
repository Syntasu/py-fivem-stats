...
class Snapshotter:
    ...
    def generateOutput(self):
        ...
        self.output.append(self.resourceCount.GetCount())                                           # Count all the resources form the countlist.
        self.output.append(self.resourceCount.GetResultTop(250))                                    # Count all the resources of the server
